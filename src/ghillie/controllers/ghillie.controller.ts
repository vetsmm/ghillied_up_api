...
export class GhillieController {
  ...
  async getAllGhillies(
    ...
    const { ghillies, count } = await this.ghillieService.getGhillies(ctx, {
      limit: query.limit,
      offset: query.offset,
    });
    return {
  ...
  async getCurrentUsersGhillies(
    ...
    const ghillies = await this.ghillieService.getGhilliesForCurrentUser(ctx);
    return {
      data: ghillies,
      meta: {},
    };
  ...
  async getAllGhilliesWithFilter(
    ...
    const { ghillies, count } = await this.ghillieService.getGhillies(
      ctx,
      requestQuery,
    );
    return {
  ...
  @ApiResponse({
    status: HttpStatus.OK,
    type: BaseApiResponse<GhillieDetailDto>,
  })
  @ApiResponse({
    status: HttpStatus.NOT_FOUND,
  })
  ...
  async addTopics(
    ...
    return await this.ghillieService.addTopics(
      ctx,
      id,
  ...
  async deleteTopics(
    ...
    return await this.ghillieService.removeTopics(
      ctx,
      id,
