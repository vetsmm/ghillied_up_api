...
exports.PostFeedController = void 0;
...
var PostFeedController = /** @class */ (function () {
    function PostFeedController(logger, postFeedService) {
        this.logger = logger;
        this.postFeedService = postFeedService;
        this.logger.setContext(PostFeedController_1.name);
    }
    PostFeedController_1 = PostFeedController;
    // create post
    PostFeedController.prototype.getFeed = function (ctx, body) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, posts, pageInfo;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this.postFeedService.getFeed(ctx, body)];
                    case 1:
    ...
    ], PostFeedController.prototype, "getFeed");
    PostFeedController = PostFeedController_1 = __decorate([
        (0, swagger_1.ApiTags)('post-feed'),
        (0, common_1.Controller)('post-feed')
    ], PostFeedController);
