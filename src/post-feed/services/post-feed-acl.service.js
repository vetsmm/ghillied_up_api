...
exports.PostFeedAclService = void 0;
var common_1 = require("@nestjs/common");
var client_1 = require("@prisma/client");
var shared_1 = require("../../shared");
var PostFeedAclService = /** @class */ (function (_super) {
    __extends(PostFeedAclService, _super);
    function PostFeedAclService() {
    ...
    PostFeedAclService.prototype.isUserPostOwner = function (post, user) {
        return post.postedById === user.id;
    };
    PostFeedAclService = __decorate([
        (0, common_1.Injectable)()
    ], PostFeedAclService);
    return PostFeedAclService;
}(shared_1.BaseAclService));
exports.PostFeedAclService = PostFeedAclService;
