...
export class PostCommentController {
    ...
    async createCommentReply(
        ...
        @Body() createCommentInput: CreateCommentReplyDto,
    ): Promise<CommentDetailDto> {
        this.logger.log(ctx, `${this.createComment.name} was called`);
        return await this.postCommentService.createCommentReply(
            ctx,
            parentCommentId,
            createCommentInput,
        );
    ...
    async getChildComments(
        ...
        const comments =
            await this.postCommentService.getPostCommentsChildrenByIds(
                ctx,
                children,
            );
        return {
    ...
    @ApiOperation({
        summary: 'Gets replies for a given parent comment',
    })
    @ApiResponse({
        status: HttpStatus.OK,
        type: SwaggerBaseApiResponse([CommentDetailDto]),
    ...
    async getCommentReplies(
        ...
        this.logger.log(ctx, `${this.getCommentReplies.name} was called`);
        return await this.postCommentService.getPostCommentReplies(
            ctx,
            parentCommentId,
            page,
            take,
