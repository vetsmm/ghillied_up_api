...
exports.PostCommentAclService = void 0;
var common_1 = require("@nestjs/common");
var client_1 = require("@prisma/client");
var shared_1 = require("../../shared");
var PostCommentAclService = /** @class */ (function (_super) {
    __extends(PostCommentAclService, _super);
    function PostCommentAclService() {
        ...
        _this.canDo([client_1.UserAuthority.ROLE_USER, client_1.UserAuthority.ROLE_VERIFIED_MILITARY], [shared_1.Action.Update], _this.isUserCommentOwner);
        // Only an admin can do a hard delete
        _this.canDo(client_1.UserAuthority.ROLE_ADMIN, [shared_1.Action.Delete]);
        return _this;
    }
    PostCommentAclService.prototype.isUserCommentOwner = function (comment, user) {
        return comment.createdById === user.id;
    };
    PostCommentAclService = __decorate([
        (0, common_1.Injectable)()
    ], PostCommentAclService);
    return PostCommentAclService;
}(shared_1.BaseAclService));
exports.PostCommentAclService = PostCommentAclService;
