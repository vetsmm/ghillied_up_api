...
exports.PostReactionAclService = void 0;
var common_1 = require("@nestjs/common");
var client_1 = require("@prisma/client");
var shared_1 = require("../../shared");
var PostReactionAclService = /** @class */ (function (_super) {
    __extends(PostReactionAclService, _super);
    function PostReactionAclService() {
        ...
        _this.canDo([client_1.UserAuthority.ROLE_USER, client_1.UserAuthority.ROLE_VERIFIED_MILITARY], [shared_1.Action.Update]);
        // Only an admin can do a hard delete
        _this.canDo([client_1.UserAuthority.ROLE_USER, client_1.UserAuthority.ROLE_VERIFIED_MILITARY], [shared_1.Action.Delete]);
    ...
    PostReactionAclService = __decorate([
        (0, common_1.Injectable)()
    ], PostReactionAclService);
    return PostReactionAclService;
}(shared_1.BaseAclService));
exports.PostReactionAclService = PostReactionAclService;
