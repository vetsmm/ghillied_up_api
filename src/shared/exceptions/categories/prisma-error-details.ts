export const CommonErrorDetails = {
   ...
   */
  P1000:
    'An authentication error occurred while connecting to the database server.',
  /**
...
export const QueryErrorDetails = {
  /**
...
export const MigrationErrorDetails = {
  /**
   ...
   */
  P3005:
    'The database schema for the database is not empty. Read more about how to baseline an existing production database: https://pris.ly/d/migrate-baseline',
  /**
   ...
   */
  P3010:
    'Migration name is too long. It must not be longer than 200 characters (bytes).',
  /**
   ...
   */
  P3013:
    'The datasource provider arrays are no longer supported in migrate. Please change your datasource to use a single provider. Read more at https://pris.ly/multi-provider-deprecation',
  /**
   ...
   */
  P3015:
    'Could not find the migration file with the specified migration file path. Please delete the directory or restore the migration file.',
  /**
   ...
   */
  P3019:
    'The datasource provider in the schema does not match the one specified in the migration_lock.toml, `{expected_provider}`. Please remove your current migration directory and start a new migration history with prisma migrate dev. Read more: https://pris.ly/d/migrate-provider-switch',
  /**
...
export const PrismaErrorDetails = {
  ...CommonErrorDetails,
