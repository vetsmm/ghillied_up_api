...
var CreateUserInput = /** @class */ (function () {
    ...
    __decorate([
        (0, swagger_1.ApiProperty)({ type: Date, example: '2020-01-01' }),
        (0, class_validator_1.IsOptional)(),
        (0, class_validator_1.IsDate)(),
        (0, class_transformer_1.Type)(function () { return Date; })
    ], CreateUserInput.prototype, "serviceEntryDate");
    __decorate([
        (0, swagger_1.ApiProperty)({ type: Date, example: '2020-01-01' }),
        (0, class_validator_1.IsOptional)(),
        (0, class_validator_1.IsDate)(),
        (0, class_transformer_1.Type)(function () { return Date; })
    ], CreateUserInput.prototype, "serviceExitDate");
    __decorate([
        (0, swagger_1.ApiProperty)(),
        (0, class_validator_1.IsEnum)(client_1.ServiceBranch)
    ], CreateUserInput.prototype, "branch");
    __decorate([
        (0, swagger_1.ApiProperty)(),
        (0, class_validator_1.IsEnum)(client_1.ServiceStatus)
    ], CreateUserInput.prototype, "serviceStatus");
